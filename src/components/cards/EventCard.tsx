import { Event } from '@/data/sampleData';
      ...
      <CardContent className="p-0">
        <div className="relative h-48 overflow-hidden">
          ...
          <div className="absolute top-4 left-4 transform group-hover:scale-110 transition-transform duration-300">
            <Badge className={`${categoryColors[event.category]} shadow-lg`}>
        ...
        <div className="p-5">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 text-muted-foreground group-hover:translate-x-1 transition-transform duration-300">
              <Calendar className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="flex items-center gap-2 text-muted-foreground group-hover:translate-x-1 transition-transform duration-300 delay-75">
              <Clock className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
            ...
            <div className="flex items-center gap-2 text-muted-foreground group-hover:translate-x-1 transition-transform duration-300 delay-100">
              <MapPin className="w-4 h-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
